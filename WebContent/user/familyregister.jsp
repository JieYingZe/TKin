...
<body>
	...
	<div class="container"> 
	<s:form action="familyRegister" theme="bootstrap" cssClass="form-horizontal form-signin">
		...
		<s:textfield type="number" min="0" max="20" value="1" name="family.numOfChildren" label="孩子个数"  />
		<s:select
                        label="地址"
